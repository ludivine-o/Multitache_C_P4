...
osThreadId_t thread_red_led_handle;
osThreadId_t thread_blue_led_handle;
osThreadId_t thread_green_led_handle;
...
osSemaphoreId_t sem_thread_led;
...
int main(void)
{
	...
	sendToLog = osMessageQueueNew(16, 12, NULL);
	...
	sem_thread_led = osSemaphoreNew(10,0,NULL);
